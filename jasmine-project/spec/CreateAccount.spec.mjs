...
describe('CreateAccount Component', () => {
  ...
  it('handles user input correctly', () => {
    ...
    expect(usernameInput.value).toBe('student123');
  ...
  it('submits form for valid student user', async () => {
    fireEvent.change(screen.getByLabelText(/username/i), { target: { value: 'student123' } });
    fireEvent.change(screen.getByLabelText(/password/i), { target: { value: 'password123' } });
    fireEvent.change(screen.getByLabelText(/user type/i), { target: { value: 'student' } });
    fireEvent.change(screen.getByLabelText(/student number/i), { target: { value: '123456' } });
    ...
    // Ensure navigation to the OTP page after successful registration
    await waitFor(() => {
