...
//             const response = await axios.get(`http://localhost:8080/guest/guestNumber/${guestNumber}`, {
//                 headers: {
...
//         try {
//             const response = await axios.get(`http://localhost:8080/guest/${guestId}/Beneficiaries`, {
//                 headers: {
//                     'Content-Type': 'application/json',
//                     'Accept': 'application/json',
//                     'Authorization': `Bearer ${localStorage.getItem('token')}`,
...
//                 axios.get(`http://localhost:8080/violation/studentId/${studentId}`, {
//                     headers: {
//                         'Content-Type': 'application/json',
//                         'Accept': 'application/json',
//                         'Authorization': `Bearer ${localStorage.getItem('token')}`,
